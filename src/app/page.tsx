    ...
    <main ref={revealRef} className="space-y-0 pb-0 overflow-x-hidden">
      ...
      <section className="py-8 sm:py-12 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex lg:grid lg:grid-cols-4 gap-3 sm:gap-4 overflow-x-auto lg:overflow-visible snap-x lg:snap-none snap-mandatory pb-4 lg:pb-0 no-scrollbar scroll-smooth -mx-4 px-4 sm:mx-0 sm:px-0">
            {[
              ...
              <div key={c.n} className={`reveal ${i ? `reveal-delay-${i}` : ''} shrink-0 lg:shrink snap-start lg:snap-align-none w-[72%] sm:w-[260px] lg:w-auto bg-white rounded-2xl border border-slate-200 p-4 shadow-sm hover:shadow-md transition duration-300`}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="reveal bg-white text-slate-900 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-2xl">
            ...
            <div className="px-4 sm:px-8 py-6 space-y-5">
              ...
              <div className="reveal flex lg:grid lg:grid-cols-3 gap-4 overflow-x-auto lg:overflow-visible snap-x lg:snap-none snap-mandatory pb-4 lg:pb-0 no-scrollbar scroll-smooth -mx-4 px-4 sm:mx-0 sm:px-0">
                {WADAH_DETAIL.map((col, idx) => (
                  <div key={col.title} className={`${col.light} shrink-0 lg:shrink snap-start lg:snap-align-none w-[86%] sm:w-[340px] lg:w-auto rounded-2xl border ${col.border} overflow-hidden ${idx ? `reveal-delay-${idx}` : ''}`}>
      ...
      <section className="py-8 sm:py-12 bg-white relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex lg:grid lg:grid-cols-3 gap-3 sm:gap-4 overflow-x-auto lg:overflow-visible snap-x lg:snap-none snap-mandatory pb-4 lg:pb-0 no-scrollbar scroll-smooth -mx-4 px-4 sm:mx-0 sm:px-0">
            {QUICK_NAV.map((item, idx) => (
              <Link key={item.href} href={item.href} className={`reveal ${idx ? `reveal-delay-${idx % 3}` : ''} shrink-0 lg:shrink snap-start lg:snap-align-none w-[46%] sm:w-[180px] lg:w-auto group ${item.bg} border ${item.border} rounded-2xl p-4 hover:shadow-md transition duration-300 flex flex-col gap-3`}>
